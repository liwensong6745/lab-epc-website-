  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F5F5F7]">
      <div className="text-center px-8">
        ...
        <Link href="/" className="inline-flex items-center px-10 py-4 bg-[#1D1D1F] text-white font-medium text-sm tracking-[0.1em] rounded-md btn-shadow hover:bg-[#007AFF] transition-all">
          返回首页
        </Link>
      </div>
    </div>
