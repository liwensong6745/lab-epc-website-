  ...
  return (
    <>
            ...
            {cases.map((c, i) => (
              ...
              >
                ...
                <div className="lg:w-2/5 flex flex-col justify-center px-10 md:px-14 py-16 md:py-20">
                  ...
                  <h2 className="text-2xl md:text-3xl font-light text-[#1D1D1F] tracking-tight leading-tight mb-4"
                    style={{ fontFamily: '"Inter", "Noto Sans SC", sans-serif', fontWeight: 300 }}>
                    {c.title}
                  </h2>
                  <p className="text-xs text-black/20 font-light mb-8">
                  ...
                  {c.results && c.results.length > 0 && (
                    <ul className="space-y-1.5 mb-8">
                      {c.results.map((r) => (
                        <li key={r} className="flex items-center gap-2 text-xs text-black/35 font-light">
                  ...
                  {c.testimonial && (
                    <div className="border-l-2 border-[#007AFF]/15 pl-4 mb-8">
                      <p className="text-sm text-black/35 font-light italic leading-relaxed">
                        &ldquo;{c.testimonial.quote}&rdquo;
                      </p>
                      <p className="text-xs text-black/20 font-light mt-2">
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center gap-3 text-black/20 hover:text-[#007AFF] transition-colors duration-500 group"
                  >
      ...
      <section className="py-20 md:py-28 bg-white text-center">
        <div className="max-w-[1440px] mx-auto px-8 lg:px-16">
          <p className="text-black/25 text-xs font-light tracking-[0.2em]"
            style={{ fontFamily: '"Inter", "Noto Sans SC", sans-serif', fontWeight: 300 }}>
            Start your project
          </p>
          <Link
