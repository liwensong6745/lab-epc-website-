      ...
      <div className="max-w-[1440px] mx-auto px-8 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          {cases.map((c) => (
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden mb-8 shadow-[0_4px_24px_rgba(0,0,0,0.04)]">
                <img
                  src={c.thumbnail}
                  alt={c.title}
                ...
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1.5 bg-white/90 text-dark text-xs font-medium tracking-wider uppercase">
                    {c.industry}
                  </span>
                </div>
              </div>
              <h3 className="text-xl font-bold text-dark mb-3 group-hover:text-accent transition-colors tracking-tight">
                {c.title}
              </h3>
        ...
        <div className="mt-20">
          <Link
            href="/cases"
            className="inline-flex items-center gap-3 text-dark font-medium text-sm tracking-wider hover:text-accent transition-colors group"
          >
            查看全部案例
