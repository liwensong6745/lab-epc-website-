        ...
        <div className="max-w-[1440px] mx-auto px-8 lg:px-16">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-6">
              <a href="tel:15711406648" className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-medium bg-[#1D1D1F] text-white rounded-md btn-shadow select-text">
