...
<a href="#" className="w-7 h-7 rounded-full bg-[#1D1D1F] flex items-center justify-center hover:bg-[#07C160] transition-colors">
                <svg className="w-3.5 h-3.5 text-white/70" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="tencent://message/?uin=123456789" className="w-7 h-7 rounded-full bg-[#1D1D1F] flex items-center justify-center hover:bg-[#12B7F5] transition-colors">
                <svg className="w-3.5 h-3.5 text-white/70" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.003 2c-2.265 0-6.29 1.364-6.29 7.325v1.195S3.55 14.96 3.55 17.858v.21c0 .33.255.614.584.703a.732.732 0 00.436-.028c.453-.195 1.723-.752 2.36-1.041 1.113.383 3.013.658 5.073.658 2.112 0 4.009-.279 5.109-.654.638.294 1.905.858 2.357 1.054a.722.722 0 00.442.03.724.724 0 00.58-.704v-.21c0-2.898-2.134-7.32-2.134-7.32V9.325c0-5.96-3.99-7.325-6.254-7.325z" />
                </svg>
              </a>
            </div>
          </div>
